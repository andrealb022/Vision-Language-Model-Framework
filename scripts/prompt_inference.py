...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/prompt_inference.yaml",
    ...
    # Output dir
    output_dir = os.path.join(project_root or ".", f"eval/prompt_inference/{model_name}_{quantization}/{dataset_name}")
    ...
    transform = None
    dataset = DatasetFactory.create_dataset(dataset_name, base_path=base_path, split="test", transform=transform)
